...
class Data {
    ...
    public static function int_1dvector(length: Int, default_value: Int = 0): Vector<Int> {
    ...
    public static function int_2dvector(width: Int, height: Int, default_value: Int): Vector<Vector<Int>> {
