...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("data/music/music.mp3", __ASSET__data_music_music_mp3);
		type.set ("data/music/music.mp3", AssetType.MUSIC);
		className.set ("data/text/hi.txt", __ASSET__data_text_hi_txt);
		type.set ("data/text/hi.txt", AssetType.TEXT);
		className.set ("data/text/items.txt", __ASSET__data_text_items_txt);
		type.set ("data/text/items.txt", AssetType.TEXT);
...
@:keep @:bind #if display private #end class __ASSET__data_music_music_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__data_text_hi_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__data_text_items_txt extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__data_fonts_pixelfj8_pixelfj8_eot extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__data_fonts_pixelfj8_pixelfj8_ttf extends flash.text.Font { }
@:keep @:bind #if display private #end class __ASSET__data_fonts_pixelfj8_pixelfj8_woff extends flash.utils.ByteArray { }
...
@:file("data/music/mp3/music.mp3") #if display private #end class __ASSET__data_music_music_mp3 extends lime.utils.Bytes {}
@:file("data/text/hi.txt") #if display private #end class __ASSET__data_text_hi_txt extends lime.utils.Bytes {}
@:file("data/text/items.txt") #if display private #end class __ASSET__data_text_items_txt extends lime.utils.Bytes {}
